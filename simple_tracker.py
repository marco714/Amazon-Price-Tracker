...
class GenerateReport:
    ...
    def get_best_item(self):
        ...
        try:
            ...
            print(e)
            print("Problem with sorting item")
            return None
...
class AmazonAPI:
    ...
    def run(self):
        ...
        print("Getting info about Product")

        product = self.get_products_info(links)
        print(f"Got info about {len(product)} products ....")
        self.driver.quit()
        return product
    ...
    def get_single_product_info(self, uniqueId):
        print(f"Product ID: {uniqueId} - getting data....")  

        product_short_url = self.shorten_url(uniqueId)
    ...
    def get_price(self):
        ...
        try:
            ...
            try:
                ...
                print(e)
                print(f"Can't get a price of a product - {self.driver.current_url}")
                return None
        except Exception as e:
